...
public class OI {
    ...
    public JoystickButton dock3;
    public JoystickButton dock4;
    ...
    public OI() {
        ...
        dock4 = new JoystickButton(driverJoy1, 4);
        dock4.whileHeld(new UltraDock());
        dock3 = new JoystickButton(driverJoy1, 3);
        dock3.whileHeld(new UltraDock());

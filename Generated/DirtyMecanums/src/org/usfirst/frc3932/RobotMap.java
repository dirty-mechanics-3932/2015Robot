...
public class RobotMap {
    ...
    public static Encoder sensorsLeftFrontEncoder;
    ...
    public static void init() {
        ...
        sensorsLeftFrontEncoder = new Encoder(2, 3, false, EncodingType.k4X);
        LiveWindow.addSensor("sensors", "LeftFrontEncoder", sensorsLeftFrontEncoder);
        sensorsLeftFrontEncoder.setDistancePerPulse(1.0);
        sensorsLeftFrontEncoder.setPIDSourceParameter(PIDSourceParameter.kRate);

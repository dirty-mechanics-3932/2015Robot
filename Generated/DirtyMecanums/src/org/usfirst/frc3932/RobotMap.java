...
public class RobotMap {
    ...
    public static PIDController armsPIDController1;
    ...
    public static void init() {
        ...
        toteTabsRightToteTabsSpike = new Relay(1);
        LiveWindow.addActuator("ToteTabs", "RightToteTabsSpike", toteTabsRightToteTabsSpike);
        
        canTabsCanTabsSpike = new Relay(2);
        LiveWindow.addActuator("CanTabs", "CanTabsSpike", canTabsCanTabsSpike);
        
        armsArmWidthCANTalon = new CANTalon(10);
        
        
        armsArmEncoder = new AnalogPotentiometer(4, 1.0, 0.0);
        LiveWindow.addSensor("Arms", "ArmEncoder", armsArmEncoder);
        
        armsPIDController1 = new PIDController(1.0, 0.0, 0.0, 0.0, armsArmEncoder, armsArmWidthCANTalon, 0.02);
        LiveWindow.addActuator("Arms", "PID Controller 1", armsPIDController1);
        armsPIDController1.setContinuous(false); armsPIDController1.setAbsoluteTolerance(0.2); 
        armsPIDController1.setOutputRange(-1.0, 1.0);        

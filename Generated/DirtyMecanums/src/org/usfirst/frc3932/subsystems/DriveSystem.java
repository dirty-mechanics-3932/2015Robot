...
public class DriveSystem extends Subsystem {
    ...
    AnalogInput leftForwardRangeFinder = RobotMap.driveSystemLeftForwardRangeFinder;
    AnalogInput rightForwardRangeFinder = RobotMap.driveSystemRightForwardRangeFinder;
    AnalogInput leftDownRangeFinder = RobotMap.driveSystemLeftDownRangeFinder;
    AnalogInput rightDownRangeFinder = RobotMap.driveSystemRightDownRangeFinder;
...
//        gyroOutput.reset();
    ...
    {
    	return (leftDownRangeFinder.getAverageVoltage() <= 1 || rightDownRangeFinder.getAverageVoltage() <= 1);
    }
	...
	{
		return (leftForwardRangeFinder.getAverageVoltage() > VOLTAGE_AT_WALL_DOCK);
	}
	
	public boolean isRightSideTargetReached()
	{
		return (rightForwardRangeFinder.getAverageVoltage() > VOLTAGE_AT_WALL_DOCK);
	}

 ...
 *
 */
public class  LeftSideMoveForward extends PIDCommand {

    public LeftSideMoveForward() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PID
        super("LeftSideMoveForward", 1.0, 0.0, 0.0, 0.02);
    ...
    protected boolean isFinished() {
        return Robot.driveSystem.isLeftSideTargetReached();
    }

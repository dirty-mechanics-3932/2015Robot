 ...
 *
 */
public class  RightSideDock extends PIDCommand {

    public RightSideDock() {
        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PID
        super("RightSideDock", 5.0, 0.0, 60.0, 0.02);
    ...
    protected double returnPIDInput() {
        ...
        return RobotMap.driveSystemRightForwardRangeFinder.pidGet();
